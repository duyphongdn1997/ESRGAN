...
from app.ml.model.model import Generator, Discriminator, initialize_weights
from tqdm import tqdm
from app.ml.data_loader.dataset import MyImageFolder
...
def train_fn(
    ...
    for idx, (low_res, high_res) in enumerate(loop):
        ...
        if idx % 100 == 0 and idx > 0:
            plot_examples("test_images/", gen_)
